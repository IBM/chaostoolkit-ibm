...
def add_volume_to_instance(configuration: Configuration,
    ...
    try:
        ...
        service.create_instance_volume_attachment(instance_id=instance_id, volume=identity,
...
def stop_multiple_instances(configuration: Configuration,
    ...
    for instance in output_dict:
        if instance['status'] == 'running':
            ...
            if tag:
                tag_virtual_instance(configuration=configuration, instance_id=instance['id'], service=service,
                                     tagname='stop_multiple_instances')
    ...
    try:
        ...
        for pool in lb_pools:
            ...
            for member in all_members:
                ...
                current_instance = [instance for instance in instances if
                                    instance['network_interfaces'][0]['primary_ipv4_address'] == ip_address]
